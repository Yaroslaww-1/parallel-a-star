...
internal class SequentialAStarShortestPathSearchTest {
    ...
    fun search() {
        ...
        val actualPath = SequentialAStarShortestPathSearch(graph, AStarEuclideanDistanceHeuristic()).search(source, destination)
